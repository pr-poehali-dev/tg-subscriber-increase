...
const LandingPage = ({ scrollToSection, onRegisterClick }: LandingPageProps) => {
  return (
    <>
        ...
        <div className="container mx-auto text-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-primary to-secondary text-white hover:opacity-90 transition-opacity px-8 py-6 text-lg"
